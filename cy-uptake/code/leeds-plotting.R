...
msoas <- readOGR("/media/SAMSUNG/geodata/UK2011boundaries/england-msoas/", "England_msoa_2011_gen")
head(msoas@data)
...
msoa.leeds <- msoa[ grepl("Leeds|Bradf|Kirk|Wakef|Cald", msoa$NAME), ]
...
head(msoa.leeds@data)
summary(msoa.leeds@data)

msoa.leeds <- spTransform(msoa.leeds, CRS("+init=epsg:4326"))
head(msoa.leeds@data)
names(msoa.leeds)
msoa.leeds@data <- msoa.leeds@data[-c(32:34)]
writeOGR(msoa.leeds, "/media//SAMSUNG/repos/bikeR/geodata/", "msoaWYB", "ESRI Shapefile")
