...
```{r fig.cap="Scatterplot of the proportion of commuters who report using a bicycle the their main means of travel to work in 2001 (x axis) and 2011 (y axis). Colours correspond to English regions.", fig.width=7, fig.height=8, echo=FALSE}
